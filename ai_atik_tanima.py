...
class AtikTanimaMotoru:
    ...
    def _analiz_et(self, dt):
        ...
        try:
            ...
            rgb    = rgb[::-1]           # Y ekseni duzelt (Kivy ters)
            # Android'de texture 90 derece donuk gelir, numpy ile duzelt
            try:
                from kivy.utils import platform
                if platform == 'android':
                    rgb = np.rot90(rgb, k=1)  # 90 derece saat yonu tersine
            except Exception:
                pass
